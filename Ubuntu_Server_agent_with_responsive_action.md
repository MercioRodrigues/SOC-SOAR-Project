...
If you follow the Windows 10 VM part on how to add and set up TheHive inside Shuffle you already know how to proceed, you can go back to that <a href="Windows_10_Agent.md#thehive">Text</a>
