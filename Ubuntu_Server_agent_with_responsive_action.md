...
If you follow the Windows 10 VM part on how to add and set up TheHive inside Shuffle you already know how to proceed, you can go back to that [text](SOC-SOAR-Project/blob/main/Windows_10_Agent#thehive)
